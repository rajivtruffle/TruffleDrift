...
(function () {
  ...
  (function setLanguageBackground() {
    ...
    img.onerror = () => {
      ...
      const fallbacks = [
        `../assets/Truffle_${lang}.png`,
        `/assets/Truffle_${lang}.png`,
        `${base}assets/Truffle_en.png`,
      ];
  ...
  window.addEventListener("onEmbeddedMessagingReady", () => {
    ...
    try {
      if (window.embeddedservice_bootstrap?.settings) {
        embeddedservice_bootstrap.settings.language = context.sfLanguage; // e.g., en_US
      }
    } catch (e) {
  ...
  (function ensureESW() {
    ...
    const DEPLOY = "Truffle";
    const SNIPPET = "https://tr1755614761355.my.site.com/ESWTruffle1756223066778";
    const BOOT_URL = SNIPPET + "/assets/js/bootstrap.min.js";
    ...
    function initESW() {
      ...
      try {
        ...
        console.log("💬 Embedded Messaging initialized (Truffle)");
        return true;
      } catch (err) {
